...
2. The namespace of the code within the libraries is identically to the name of the library. So for example all content of `libKitsunemimiPersistence` has the namespace `Kitsunemimi::Persistence`.
