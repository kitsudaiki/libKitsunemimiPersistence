...
# copy build-result and include-files into the result-directory
cp "$LIB_KITSUNE_PERSISTENCE_DIR/src/libKitsunePersistence.so.0.4.1" "$RESULT_DIR/"
...
ln -s libKitsunePersistence.so.0.4.1 libKitsunePersistence.so.0.4
ln -s libKitsunePersistence.so.0.4.1 libKitsunePersistence.so.0
ln -s libKitsunePersistence.so.0.4.1 libKitsunePersistence.so
